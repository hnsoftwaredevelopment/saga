...
public partial class DetailedGridView : System.Windows.Controls.UserControl
{
    ...
    private void ViewModelPropertyChanged(object? sender, PropertyChangedEventArgs e)
    {
        if (e.PropertyName == nameof(LibraryViewModel.BookRevealRequest) &&
            attachedViewModel is { SelectedView: LibraryView.Detailed, BookRevealRequest: { } request } viewModel)
        {
    ...
    private void RevealBook(LibraryViewModel viewModel, Guid bookId)
    {
        ...
        {
            BookRevealScrollHelper.ScrollListToBook(DetailedGroupsList, viewModel, bookId, grouped: true);
        }
        else
        {
