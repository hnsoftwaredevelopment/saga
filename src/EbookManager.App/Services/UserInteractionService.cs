    ...
    IAppSettingsStore settingsStore) : IUserInteractionService
{
    ...
    {
        cancellationToken.ThrowIfCancellationRequested();
        var window = new MetadataQualityAuthorRepairWindow(repair);
        if (System.Windows.Application.Current?.MainWindow is { } owner)
        {
            window.Owner = owner;
        }
    ...
    {
        cancellationToken.ThrowIfCancellationRequested();
        var window = new MetadataQualityLanguageRepairWindow(repair);
        if (System.Windows.Application.Current?.MainWindow is { } owner)
        {
            window.Owner = owner;
        }
    ...
    {
        cancellationToken.ThrowIfCancellationRequested();
        var window = new MetadataQualitySeriesRepairWindow(repair);
        if (System.Windows.Application.Current?.MainWindow is { } owner)
        {
            window.Owner = owner;
        }
    ...
    {
        cancellationToken.ThrowIfCancellationRequested();
        var window = new MetadataQualityCoverSearchWindow(search, cancellationToken);
        if (System.Windows.Application.Current?.MainWindow is { } owner)
        {
            window.Owner = owner;
        }
