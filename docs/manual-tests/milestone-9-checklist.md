...
- [ ] Use the Group by dropdown in Detailed view, List view, and Bookshelf view and confirm grouping is applied automatically.
- [ ] Use Group by Author and Then by Series and confirm a multi-author book appears under each individual author instead of one combined author header.
