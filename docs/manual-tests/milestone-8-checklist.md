...
- [ ] Confirm Save still copies the selected format to Downloads.
- [ ] Confirm Save to still copies the selected format to a user-selected folder.
- [ ] Confirm the short save confirmation still follows the selected UI language.
