...
- [ ] Confirm duplicate candidate row actions use compact colored icons with tooltips for merge, delete, and details.
- [ ] Confirm duplicate candidate icons are visible immediately when the window opens.
